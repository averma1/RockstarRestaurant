...
import edu.ithaca.comp345.Rockstar.ui.HostView;
...
//            main.host.seatCustomers(1,10);
//            main.host.seatCustomers(2,10);
    ...
    public static void main(String[] args) throws IOException {
        ...
        SwingTestUtil.showPanelInTestFrame(new HostView(main.host, test1, view));
    }
